window.addEventListener('DOMContentLoaded', function(){
    ...
    var createScene = function () {
        ...
        var light = new BABYLON.PointLight("omni2", new BABYLON.Vector3(250, 0, 250), scene);
        var light = new BABYLON.PointLight("omni3", new BABYLON.Vector3(250, 0, -250), scene);
        var light = new BABYLON.PointLight("omni4", new BABYLON.Vector3(-250, 0, -250), scene);
        ...
        var south_s = BABYLON.Mesh.CreateSphere('south', 32, 40, scene);

        south_s.position.y = 30;
        south_s.position.x = 10;
